...
@Composable
fun ScientificCalculatorScreen(onBackToMenu: () -> Unit) {
    ...
    Column(
        ...
        Column(
            ...
            Text(
                text = secondaryText,
                autoSize = TextAutoSize.StepBased(minFontSize = 20.sp, maxFontSize = 40.sp, stepSize = 2.sp),
                maxLines = 3,
                color = Color.White,
...
fun SciCalculatorUIPreview() {
    ScientificCalculatorScreen(onBackToMenu = {})
}
